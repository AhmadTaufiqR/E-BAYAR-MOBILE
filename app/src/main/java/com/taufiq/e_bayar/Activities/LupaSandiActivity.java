...
import com.taufiq.e_bayar.ActivityInput_otp;
...
public class LupaSandiActivity extends AppCompatActivity {
    ...
    Button btnCari ,btnEdit,btnOke;
    CardView cardDialog;
    TextView nomerHpDialog;
    // [START declare_auth]
    // [END declare_auth]
...
//        cardDialog = findViewById(R.id.id_dialog_pop_up);
//        btnEdit = findViewById(R.id.btnEdit);
//        btnOke = findViewById(R.id.btnOK);
//        nomerHpDialog = findViewById(R.id.tvDescriptionNumberHp);
        btnCari.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                cardDialog.setVisibility(View.VISIBLE);
                nomerHpDialog.setText(editTextEmail.getText().toString());
            }
        });
        btnOke.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sendMessage(editTextEmail.getText().toString(),otp);
                Intent intent = new Intent(LupaSandiActivity.this, ActivityInput_otp.class);
        ...
        btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                cardDialog.setVisibility(View.INVISIBLE);
            }
        });
    ...
    public void sendMessage(String receiveEmail,String otpKode){
        ...
        try {
            String stringSenderEmail = "e41212014@student.polije.ac.id";
            String stringPasswordSenderEmail = "Lyna_0943";
            String stringHost = "smtp.gmail.com";
            char[] arrPw = stringPasswordSenderEmail.toCharArray();
            ...
            mimeMessage.setContent ("\n" +
                    ...
                    "                            <img src=\"https://i.ibb.co/qk7NjkN/icon-logo.png\" title=\"logo\" alt=\"logo\" border=\"0\"></a>\n" +
                    "                        </td>\n" +
                    "                    </tr>\n" +
                    "                    <tr>\n" +
                    ...
                    "                                            Untuk mereset akun Anda, masukan kode di atas.\n" +
                    "                                           \n" +
                    "                                        </p>\n" +
                    "                                    \n" +
                    "                                    </td>\n" +
